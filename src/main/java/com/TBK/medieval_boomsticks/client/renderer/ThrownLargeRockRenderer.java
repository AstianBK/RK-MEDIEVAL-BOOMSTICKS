...
public class ThrownLargeRockRenderer<T extends ThrowableLargeRock> extends GeoEntityRenderer<T> {
    public ThrownLargeRockRenderer(EntityRendererProvider.Context renderManager) {
