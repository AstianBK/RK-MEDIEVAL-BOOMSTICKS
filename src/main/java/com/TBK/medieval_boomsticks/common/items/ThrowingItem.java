...
public class ThrowingItem extends Item {
    public ThrowingItem(Properties p_40512_) {
        super(p_40512_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            ThrowableWeapon throwableWeapon = new ThrowableWeapon(getTypeForItem(itemstack),p_43142_, p_43143_,itemstack);
    ...
    public EntityType<? extends ThrowableWeapon> getTypeForItem(ItemStack stack){
