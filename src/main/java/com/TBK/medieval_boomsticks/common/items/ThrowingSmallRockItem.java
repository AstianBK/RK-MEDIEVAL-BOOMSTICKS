                ...
                if (j <= 0 || player.isInWaterOrRain()) {
                    if (!p_43395_.isClientSide) {
                        ...
                        if (j == 0) {
                            ...
                            stack.setCount(1);
                            ThrowableSmallRock throwntrident = new ThrowableSmallRock(p_43395_, p_43396_,stack);
                            throwntrident.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, (float) Config.smallRockSpeed + (float)j * 0.5F, 1.0F);
